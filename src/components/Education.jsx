        ...
        <Stagger step={160} as="div">
          {education.map((edu, index) => (
            ...
            >
              ...
              {/* Content Section */}
              <div
                // One margin class per side — see the note in Experience.jsx:
                // `sm:ml-0` next to `sm:ml-44` is not a conditional, it is
                // just ml-44 (Tailwind emits it later in the stylesheet).
