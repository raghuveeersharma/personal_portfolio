...
const Education = () => {
  return (
    <section
      id="education"
      className="section-wash py-24 pb-24 clip-path-custom-3"
    >
     <div className="mx-auto w-full max-w-[1300px] px-6 md:px-10">
      {/* Section Title */}
      <Reveal className="text-center mb-16">
        <h2 className="text-4xl font-bold text-content">EDUCATION</h2>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center space-x-6">
                  {/* School Logo/Image */}
                  {/* White in both themes — see the note in
                      Experience.jsx. */}
                ...
                <p className="mt-4 text-content-muted">{edu.desc}</p>
              </div>
            </div>
          ))}
        </Stagger>
